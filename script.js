...
class Car extends Factory {
  constructor (model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, enginesize = 4, navigation = true, backupcamera = true, warranty = '100,000 miles / 5 years', make, airbags, abs, location) {
...
console.log(mazda3.customerBuild('yellow', ['weather package', ' satelite radio', ' rear spoiler']));
...
let miataRf = new Sport('miata-RF', 'grand touring', 'manual', 'hard', 'red', 'leather', 'premium', 'premium')
